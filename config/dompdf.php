...
return [
    ...
    */
    ...
    'options' => [
        ...
        'fonts' => [
            'NotoSansJP' => [
                'normal' => storage_path('fonts/NotoSansJP-Regular.ttf'),
                'bold' => storage_path('fonts/NotoSansJP-Bold.ttf'),
                'italic' => storage_path('fonts/NotoSansJP-Light.ttf'),
                'bold_italic' => storage_path('fonts/NotoSansJP-SemiBold.ttf'),
            ],
        ],
